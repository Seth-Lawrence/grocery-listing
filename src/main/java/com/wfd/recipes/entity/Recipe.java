...
public class Recipe {
  ...
  public Recipe(HashMap<String, String> recipe) {
    ...
    this.category = recipe.getOrDefault(name, null);
    this.instructions = recipe.getOrDefault(instructions, null);
    this.picture = recipe.getOrDefault(picture, null);
    this.tags = recipe.getOrDefault(tags, null);
    this.youtube = recipe.getOrDefault(youtube, null);
    this.ingredient1 = recipe.getOrDefault(ingredient1, null);
    this.ingredient3 = recipe.getOrDefault(ingredient3, null);
    this.ingredient4 = recipe.getOrDefault(ingredient4, null);
    this.ingredient5 = recipe.getOrDefault(ingredient5, null);
    this.ingredient6 = recipe.getOrDefault(ingredient6, null);
    this.ingredient7 = recipe.getOrDefault(ingredient7, null);
    this.ingredient8 = recipe.getOrDefault(ingredient8, null);
    this.ingredient9 = recipe.getOrDefault(ingredient9, null);
    this.ingredient10 = recipe.getOrDefault(ingredient10, null);
    this.ingredient11 = recipe.getOrDefault(ingredient11, null);
    this.ingredient12 = recipe.getOrDefault(ingredient12, null);
    this.ingredient13 = recipe.getOrDefault(ingredient13, null);
    this.ingredient14 = recipe.getOrDefault(ingredient14, null);
    this.ingredient15 = recipe.getOrDefault(ingredient15, null);
    this.ingredient16 = recipe.getOrDefault(ingredient16, null);
    this.ingredient17 = recipe.getOrDefault(ingredient17, null);
    this.ingredient18 = recipe.getOrDefault(ingredient18, null);
    this.ingredient19 = recipe.getOrDefault(ingredient19, null);
    this.ingredient20 = recipe.getOrDefault(ingredient20, null);
    this.measurement1 = recipe.getOrDefault(measurement1, null);
    this.measurement3 = recipe.getOrDefault(measurement3, null);
    this.measurement4 = recipe.getOrDefault(measurement4, null);
    this.measurement5 = recipe.getOrDefault(measurement5, null);
    this.measurement6 = recipe.getOrDefault(measurement6, null);
    this.measurement7 = recipe.getOrDefault(measurement7, null);
    this.measurement8 = recipe.getOrDefault(measurement8, null);
    this.measurement9 = recipe.getOrDefault(measurement9, null);
    this.measurement10 = recipe.getOrDefault(measurement10, null);
    this.measurement11 = recipe.getOrDefault(measurement11, null);
    this.measurement12 = recipe.getOrDefault(measurement12, null);
    this.measurement13 = recipe.getOrDefault(measurement13, null);
    this.measurement14 = recipe.getOrDefault(measurement14, null);
    this.measurement15 = recipe.getOrDefault(measurement15, null);
    this.measurement16 = recipe.getOrDefault(measurement16, null);
    this.measurement17 = recipe.getOrDefault(measurement17, null);
    this.measurement18 = recipe.getOrDefault(measurement18, null);
    this.measurement19 = recipe.getOrDefault(measurement19, null);
    this.measurement20 = recipe.getOrDefault(measurement20, null);
  }
